...
CREATE TABLE articles (
    ...
    title String,
    body String,
    INDEX ft_idx GLOBAL SYNC USING fulltext_relevance
    ON (body) COVER (title)
    WITH (
        tokenizer=standard,
...
CREATE TABLE products (
    ...
    name String,
    description String,
    INDEX ft_ngram_idx GLOBAL SYNC USING fulltext_plain
    ON (name)
    WITH (
        tokenizer=standard,
        use_filter_lowercase=true,
...
CREATE TABLE users (
    ...
    username String,
    email String,
    INDEX ft_edge_ngram_idx GLOBAL SYNC USING fulltext_plain
    ON (username)
    WITH (
        tokenizer=standard,
        use_filter_lowercase=true,
